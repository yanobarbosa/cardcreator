...
const r = function(r, i, a) {
    ...
    if (i && i.length > 0) {
        ...
        o = l(i.map(i => {
            ...
            if (l.rel = o ? `stylesheet` : e, o || (l.as = `script`), l.crossOrigin = ``, l.href = i, c && l.setAttribute(`nonce`, c), document.head.appendChild(l), o) return new Promise((e, t) => {
